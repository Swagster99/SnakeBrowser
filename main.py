...
import sys
# Your not suposed to be here, welcome!
print("Debug menu")
...
class MainWindow(QMainWindow):
	...
	def __init__(self, *args, **kwargs):
		...
		self.browser.setUrl(QUrl("http://frogfind.com"))
	...
	def update_title(self):
		...
		self.setWindowTitle("% s - Snake Browser (Always Registed)" % title)
...
app.setApplicationName("Snake Browser")
